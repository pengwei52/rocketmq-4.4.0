...
public class NettyServerConfig implements Cloneable {
	// NameServer/Broker 监听端口
    private int listenPort = 8888;
    // Netty 业务线程池线程个数
    private int serverWorkerThreads = 8;
    // Netty 公共任务线程池线程个数，Netty网络设计，根据业务类型会创建不同的线程池，比如处理消息发送、消息消费、心跳检测等。
    // 如果该业务类型（RequestCode）未注册线程池，则有公共线程池执行
    ...
    // 网络连接最大空闲时间，如果连接空闲时间超过该参数设置的值，连接将被关闭
